-- Simple Chat History Database Schema (SQLite compatible)
-- Stores chat sessions, their events, and preset queries in a simple, typed way
--
-- Key Features:
-- - Events-only storage: All conversation data derived from events
-- - Preset query linking: Optional linking of chat sessions to preset queries
