...
- Written by: the step agent, in one merged post-completion reflection turn shared with KB (see below) — or by you through execute_shell_command for manual fixes.
