...
- For each eval step (its execution mode lives on the step itself in `evaluation/evaluation_plan.json`; tier and tools live in `evaluation/step_config.json`):
