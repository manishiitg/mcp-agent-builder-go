...
var allKinds = map[string]kindMeta{
	...
	"pulse-fixer":         {Group: "improve", Description: "Independently apply and verify one coherent repair objective from canonical Pulse issues produced by Engineering Review", Modes: []string{"workshop"}},
...
var referenceKinds = map[string]kindMeta{
	...
	"pulse-review-fixer":    {Group: "system", Description: "Agent-owned Review then independent Fix contract: classify observations and deduplicate roots in reviewer sequences, then give one canonical repair objective to a fresh Fixer and persist typed lifecycle state.", Modes: []string{"workshop", "run"}},
