...
var referenceKinds = map[string]kindMeta{
	...
	"review-improve-log":          {Group: "system", Description: "The lightweight published Pulse journal spec: Bug/Goal verdicts, one status sentence, three Latest Pulse cells, three SQLite-backed Current work counts, reviewer freshness, material recent activity, archive, and migration rules. The Pulse popup owns issue lists, evidence, verification, costs, diagnostics, and filtering. Load before writing builder/improve.html from any /review-* or /improve-* skill or Pulse.", Modes: []string{"workshop", "run"}},
