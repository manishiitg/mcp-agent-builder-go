...
func TestWorkflowVersionUpgradePlanAddsScheduledRoutesAfterDirectReports(t *testing.T) {
	...
	if len(plan) != 8 || plan[0].label != "upgrade-schedule-execution-model" || plan[0].to != workflowContractScheduleExecutionModelVersion {
	...
	if plan[6].label != "upgrade-pulse-lifecycle-reconciliation" || plan[6].to != workflowContractPulseLifecycleReconciliationVersion || plan[7].label != "upgrade-pulse-backlog-triage" || plan[7].to != WorkflowContractCurrentVersion {
...
func TestVersion126ReceivesDedicatedPulseScheduleMigration(t *testing.T) {
	...
	if plan[5].label != "upgrade-pulse-lifecycle-reconciliation" || plan[5].to != workflowContractPulseLifecycleReconciliationVersion || plan[6].label != "upgrade-pulse-backlog-triage" || plan[6].to != WorkflowContractCurrentVersion {
...
func TestVersion127ReceivesSchedulePromptContractMigration(t *testing.T) {
	...
	if len(plan) != 6 || plan[0].label != "upgrade-schedule-prompt-contract" || plan[0].to != workflowContractSchedulePromptContractVersion {
	...
	if plan[4].label != "upgrade-pulse-lifecycle-reconciliation" || plan[4].to != workflowContractPulseLifecycleReconciliationVersion || plan[5].label != "upgrade-pulse-backlog-triage" || plan[5].to != WorkflowContractCurrentVersion {
...
func TestVersion128ReceivesFinalizerOwnershipMigration(t *testing.T) {
	...
	if len(plan) != 5 || plan[0].label != "upgrade-schedule-finalizer-ownership" || plan[0].to != workflowContractFinalizerOwnedScheduleVersion {
	...
	if plan[3].label != "upgrade-pulse-lifecycle-reconciliation" || plan[3].to != workflowContractPulseLifecycleReconciliationVersion || plan[4].label != "upgrade-pulse-backlog-triage" || plan[4].to != WorkflowContractCurrentVersion {
...
func TestVersion129ReceivesReportActivitySectionMigration(t *testing.T) {
	...
	if len(plan) != 4 || plan[0].label != "upgrade-report-activity-section" || plan[0].to != workflowContractReportActivitySectionVersion {
	...
	if plan[2].label != "upgrade-pulse-lifecycle-reconciliation" || plan[2].to != workflowContractPulseLifecycleReconciliationVersion || plan[3].label != "upgrade-pulse-backlog-triage" || plan[3].to != WorkflowContractCurrentVersion {
...
func TestVersion130ReceivesReportActivityTabMigration(t *testing.T) {
	...
	if len(plan) != 3 || plan[0].label != "upgrade-report-activity-tab" || plan[0].to != workflowContractReportActivityTabVersion {
	...
	if plan[1].label != "upgrade-pulse-lifecycle-reconciliation" || plan[1].to != workflowContractPulseLifecycleReconciliationVersion || plan[2].label != "upgrade-pulse-backlog-triage" || plan[2].to != WorkflowContractCurrentVersion {
