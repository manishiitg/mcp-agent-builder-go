...
func TestWorkflowVersionUpgradePlanAddsScheduledRoutesAfterDirectReports(t *testing.T) {
	...
	if len(plan) != 15 || plan[0].label != "upgrade-schedule-execution-model" || plan[0].to != workflowContractScheduleExecutionModelVersion {
	...
	if plan[6].label != "upgrade-pulse-lifecycle-reconciliation" || plan[6].to != workflowContractPulseLifecycleReconciliationVersion || plan[7].label != "upgrade-pulse-backlog-triage" || plan[7].to != workflowContractPulseBacklogTriageVersion || plan[8].label != "upgrade-pulse-actionable-backlog" || plan[8].to != workflowContractPulseActionableBacklogVersion || plan[9].label != "upgrade-orchestrator-step-type" || plan[9].to != workflowContractOrchestratorStepTypeVersion || plan[10].label != "upgrade-activity-tab-from-run-summary" || plan[10].to != workflowContractActivityTabFromRunSummaryVersion || plan[11].label != "upgrade-scripted-type-stays-regular" || plan[11].to != workflowContractScriptedTypeStaysRegularVersion || plan[12].label != "upgrade-declared-execution-mode-retired" || plan[12].to != workflowContractDeclaredExecutionModeRetiredVersion || plan[13].label != "upgrade-declared-execution-mode-stripped" || plan[13].to != workflowContractDeclaredExecutionModeStrippedVersion || plan[14].label != "upgrade-route-summaries" || plan[14].to != WorkflowContractCurrentVersion {
...
func TestVersion126ReceivesDedicatedPulseScheduleMigration(t *testing.T) {
	...
	if plan[5].label != "upgrade-pulse-lifecycle-reconciliation" || plan[5].to != workflowContractPulseLifecycleReconciliationVersion || plan[6].label != "upgrade-pulse-backlog-triage" || plan[6].to != workflowContractPulseBacklogTriageVersion || plan[7].label != "upgrade-pulse-actionable-backlog" || plan[7].to != workflowContractPulseActionableBacklogVersion || plan[8].label != "upgrade-orchestrator-step-type" || plan[8].to != workflowContractOrchestratorStepTypeVersion || plan[9].label != "upgrade-activity-tab-from-run-summary" || plan[9].to != workflowContractActivityTabFromRunSummaryVersion || plan[10].label != "upgrade-scripted-type-stays-regular" || plan[10].to != workflowContractScriptedTypeStaysRegularVersion || plan[11].label != "upgrade-declared-execution-mode-retired" || plan[11].to != workflowContractDeclaredExecutionModeRetiredVersion || plan[12].label != "upgrade-declared-execution-mode-stripped" || plan[12].to != workflowContractDeclaredExecutionModeStrippedVersion || plan[13].label != "upgrade-route-summaries" || plan[13].to != WorkflowContractCurrentVersion {
...
func TestVersion127ReceivesSchedulePromptContractMigration(t *testing.T) {
	...
	if len(plan) != 13 || plan[0].label != "upgrade-schedule-prompt-contract" || plan[0].to != workflowContractSchedulePromptContractVersion {
	...
	if plan[4].label != "upgrade-pulse-lifecycle-reconciliation" || plan[4].to != workflowContractPulseLifecycleReconciliationVersion || plan[5].label != "upgrade-pulse-backlog-triage" || plan[5].to != workflowContractPulseBacklogTriageVersion || plan[6].label != "upgrade-pulse-actionable-backlog" || plan[6].to != workflowContractPulseActionableBacklogVersion || plan[7].label != "upgrade-orchestrator-step-type" || plan[7].to != workflowContractOrchestratorStepTypeVersion || plan[8].label != "upgrade-activity-tab-from-run-summary" || plan[8].to != workflowContractActivityTabFromRunSummaryVersion || plan[9].label != "upgrade-scripted-type-stays-regular" || plan[9].to != workflowContractScriptedTypeStaysRegularVersion || plan[10].label != "upgrade-declared-execution-mode-retired" || plan[10].to != workflowContractDeclaredExecutionModeRetiredVersion || plan[11].label != "upgrade-declared-execution-mode-stripped" || plan[11].to != workflowContractDeclaredExecutionModeStrippedVersion || plan[12].label != "upgrade-route-summaries" || plan[12].to != WorkflowContractCurrentVersion {
...
func TestVersion128ReceivesFinalizerOwnershipMigration(t *testing.T) {
	...
	if len(plan) != 12 || plan[0].label != "upgrade-schedule-finalizer-ownership" || plan[0].to != workflowContractFinalizerOwnedScheduleVersion {
	...
	if plan[3].label != "upgrade-pulse-lifecycle-reconciliation" || plan[3].to != workflowContractPulseLifecycleReconciliationVersion || plan[4].label != "upgrade-pulse-backlog-triage" || plan[4].to != workflowContractPulseBacklogTriageVersion || plan[5].label != "upgrade-pulse-actionable-backlog" || plan[5].to != workflowContractPulseActionableBacklogVersion || plan[6].label != "upgrade-orchestrator-step-type" || plan[6].to != workflowContractOrchestratorStepTypeVersion || plan[7].label != "upgrade-activity-tab-from-run-summary" || plan[7].to != workflowContractActivityTabFromRunSummaryVersion || plan[8].label != "upgrade-scripted-type-stays-regular" || plan[8].to != workflowContractScriptedTypeStaysRegularVersion || plan[9].label != "upgrade-declared-execution-mode-retired" || plan[9].to != workflowContractDeclaredExecutionModeRetiredVersion || plan[10].label != "upgrade-declared-execution-mode-stripped" || plan[10].to != workflowContractDeclaredExecutionModeStrippedVersion || plan[11].label != "upgrade-route-summaries" || plan[11].to != WorkflowContractCurrentVersion {
...
func TestVersion129ReceivesReportActivitySectionMigration(t *testing.T) {
	...
	if len(plan) != 11 || plan[0].label != "upgrade-report-activity-section" || plan[0].to != workflowContractReportActivitySectionVersion {
	...
	if plan[2].label != "upgrade-pulse-lifecycle-reconciliation" || plan[2].to != workflowContractPulseLifecycleReconciliationVersion || plan[3].label != "upgrade-pulse-backlog-triage" || plan[3].to != workflowContractPulseBacklogTriageVersion || plan[4].label != "upgrade-pulse-actionable-backlog" || plan[4].to != workflowContractPulseActionableBacklogVersion || plan[5].label != "upgrade-orchestrator-step-type" || plan[5].to != workflowContractOrchestratorStepTypeVersion || plan[6].label != "upgrade-activity-tab-from-run-summary" || plan[6].to != workflowContractActivityTabFromRunSummaryVersion || plan[7].label != "upgrade-scripted-type-stays-regular" || plan[7].to != workflowContractScriptedTypeStaysRegularVersion || plan[8].label != "upgrade-declared-execution-mode-retired" || plan[8].to != workflowContractDeclaredExecutionModeRetiredVersion || plan[9].label != "upgrade-declared-execution-mode-stripped" || plan[9].to != workflowContractDeclaredExecutionModeStrippedVersion || plan[10].label != "upgrade-route-summaries" || plan[10].to != WorkflowContractCurrentVersion {
...
func TestVersion130ReceivesReportActivityTabMigration(t *testing.T) {
	...
	if len(plan) != 10 || plan[0].label != "upgrade-report-activity-tab" || plan[0].to != workflowContractReportActivityTabVersion {
