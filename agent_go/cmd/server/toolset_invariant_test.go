...
func knownWorkshopRegisteredToolNamesOutsideWorkflowPool() map[string]string {
	...
	add("execution sub-agent/session tools", "call_sub_agent", "call_generic_agent", "query_sub_agent", "stop_sub_agent", "get_sub_agent_conversation", "get_route_description", "get_pulse_review_result")
...
func TestToolSetInvariants(t *testing.T) {
	...
	for _, n := range []string{"get_pulse_module_state", "get_pulse_finding_backlog", "begin_pulse_fixer_run", "record_pulse_worklist", "start_pulse_fix_attempt", "mark_pulse_module_result", "record_pulse_impact", "resolve_run_concern", "mark_pulse_final_command_result"} {
	...
	for _, n := range []string{
		...
		"get_pulse_module_state", "get_pulse_finding_backlog", "begin_pulse_fixer_run", "record_pulse_worklist", "start_pulse_fix_attempt", "mark_pulse_module_result", "record_pulse_impact", "resolve_run_concern", "mark_pulse_final_command_result",
	...
	for _, n := range []string{"get_pulse_finding_backlog", "begin_pulse_fixer_run", "record_pulse_worklist", "start_pulse_fix_attempt", "mark_pulse_module_result", "record_pulse_impact", "resolve_run_concern", "mark_pulse_final_command_result", "mark_changelog_artifact_reviewed"} {
		if run[n] {
