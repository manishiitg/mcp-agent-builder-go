...
var shortformStageDescriptions = map[string]string{
	...
	"shortform-generate": "Produce the shots exactly as shortform-shotlist.md specifies, using fal-ai, google-ai, or seeddance-api per the provider and model recorded for each shot. This stage executes an approved plan; it does not re-plan. " +
