...
var longformPipeline = &Pipeline{
	...
	Stages: []PipelineStage{
		{ID: "longform-brief", Title: "Brief and narrative shape", Summary: "Confirm the message, duration, cost ceiling, and consistency requirements before anything is generated.", Output: "longform-brief.md", Skills: []string{"video-creation", "video-storytelling", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
		...
		{ID: "longform-shotlist", Title: "Shot list and prompts", Summary: "Derive every shot and its prompt from the measured narration, and cost the run.", Output: "longform-shotlist.md", Skills: []string{"video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection", "video-editing"}},
		{ID: "longform-generate", Title: "Generate shots", Summary: "Produce the approved shots, conditioned on each character's reference.", Output: "longform-generation.md", Skills: []string{"fal-ai", "google-ai", "video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
