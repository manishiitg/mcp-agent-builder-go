...
var longformPipeline = &Pipeline{
	...
	Stages: []PipelineStage{
		...
		{ID: "longform-narration", Title: "Generate narration", Summary: "Produce the voiceover in segments and measure its real duration.", Output: "longform-narration.md", Skills: []string{"video-editing", "fal-ai", "video-storytelling"}},
