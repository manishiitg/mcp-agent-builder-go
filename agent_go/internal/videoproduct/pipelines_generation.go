...
var longformStageDescriptions = map[string]string{
	...
	"longform-generate": "Produce the shots. Read longform-shotlist.md, longform-sequence-plan.json, longform-characters.md, and longform-narration.md, and generate strictly what longform-shotlist.md specifies — this stage executes a plan the user approved, it does not re-plan. Generate sequence by sequence and use fal-ai or google-ai per the model recorded for each shot. " +
...
var longformPipeline = &Pipeline{
	...
	Stages: []PipelineStage{
		{ID: "longform-brief", Title: "Brief and cinematic direction", Summary: "Lock the story, duration, cost ceiling, visual language, sound world, and continuity priorities.", Output: "longform-brief.md", Skills: []string{"video-creation", "longform-cinematic-video", "video-storytelling", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
		...
		{ID: "longform-shotlist", Title: "Sequence and shot plan", Summary: "Design the fewest continuity-controlled sequences, derive their shots from measured narration, and cost the run.", Output: "longform-shotlist.md", Artifacts: []string{"longform-sequence-plan.json"}, Skills: []string{"longform-cinematic-video", "video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection", "video-editing"}},
		{ID: "longform-generate", Title: "Generate sequences", Summary: "Produce and review continuity-controlled clips sequence by sequence.", Output: "longform-generation.md", Artifacts: []string{"longform-continuity-ledger.json"}, Skills: []string{"longform-cinematic-video", "fal-ai", "google-ai", "video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
...
var shortformPipeline = &Pipeline{
	...
	Stages: []PipelineStage{
		{ID: "shortform-brief", Title: "Brief and platform", Summary: "Confirm the message, platform, duration, and cost ceiling before anything is generated.", Output: "shortform-brief.md", Skills: []string{"video-creation", "video-storytelling", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
		...
		{ID: "shortform-shotlist", Title: "Shot list and prompts", Summary: "Turn each beat into a costed shot with its generation prompt.", Output: "shortform-shotlist.md", Skills: []string{"video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
		{ID: "shortform-generate", Title: "Generate shots", Summary: "Produce the approved shots.", Output: "shortform-generation.md", Skills: []string{"fal-ai", "google-ai", "video-cinematography", "video-provider-capabilities", "kling-video", "seedance-video", "veo-video", "minimax-h3-video", "gemini-omni-video", "video-model-selection"}},
