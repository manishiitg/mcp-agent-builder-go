...
type WorkflowScheduleRowPanel = Pick<ScheduleRunsPanelState,
  | 'presetMap' | 'isReadOnlyUser' | 'openActionMenuJobId' | 'setOpenActionMenuJobId' | 'triggering' | 'isWorkflowScoped'
  | 'runsByJob' | 'expandedRunHistoryJobIds' | 'runsLoadingJobIds' | 'deletingRunSessionIds'
...
type WorkflowScheduleRowProps = {
  job: ScheduledJob
  panel: WorkflowScheduleRowPanel
}
...
type ScheduleGroupsViewProps = {
  panel: WorkflowScheduleRowPanel & Pick<ScheduleRunsPanelState,
    | 'workflowGroups' | 'normalizedSearch' | 'activeFilter' | 'selectedWorkflowFilter' | 'expandedWorkflowKeys'
    | 'toggleWorkflowGroup' | 'handleToggleWorkflowGroupPause' | 'bulkUpdatingGroupKey'
  >
}
