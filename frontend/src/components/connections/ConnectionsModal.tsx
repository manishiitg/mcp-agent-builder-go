          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
            {view === 'detail' && detailId ? (
              ...
              <>
                ...
                {/* Table */}
                <div className="grid grid-cols-[1fr_auto_auto] gap-4 border-b border-gray-200 px-3 pb-2 dark:border-slate-700">
                  ...
                  <span className="w-36 text-right text-xs font-medium text-gray-500 dark:text-gray-400">
                    Status
                  </span>
                </div>
