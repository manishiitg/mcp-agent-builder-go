...
2. **Daily builtin schedule** — ✅ Built (2026-06-21). `builtin-org-pulse` added to
   ...
   `0 8 * * *` (daily, editable), mode multi-agent, query loads `read_skill(skills=[{"name":"builder-reference","path":"references/org-pulse.md"}])`.
...
3. **The Org Pulse reference doc** — ✅ Drafted (2026-06-21):
   `guidance/templates/system/org-pulse.md`, registered as `read_skill(skills=[{"name":"builder-reference","path":"references/org-pulse.md"}])`
