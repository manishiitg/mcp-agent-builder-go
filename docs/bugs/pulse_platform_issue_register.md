...
| [PLAT-163](pulse_platform/plat-163.md) | Engineering and Operations reviews have no durable focus rotation or coverage history, so expensive passes can repeat familiar analysis while other important themes remain unreviewed | unassigned | `partially implemented` — durable rotation lifecycle and current-focus UI shipped; richer timeline UI and live Pulse verification remain | Pulse review agenda, focus persistence, reviewer guidance, and history UI |
...
| [PLAT-162](pulse_platform/plat-162.md) | [PLAT-163](pulse_platform/plat-163.md) | [PLAT-165](pulse_platform/plat-165.md) |  |
