...
| [PLAT-163](pulse_platform/plat-163.md) | Technical and strategic reviews need durable focus rotation, one canonical technical identity, and visible coverage history | Codex | `implemented` — canonical technical migration, both focus catalogs, counts, slash/scheduled parity, and visible next-focus UI shipped; live Pulse verification remains | Pulse module registry/migrations, Gate, reviewer/Fixer contracts, focus persistence, and Pulse UI |
