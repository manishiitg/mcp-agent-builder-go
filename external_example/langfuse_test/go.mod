...
require (
	...
	mcp-agent/agent_go v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/tmc/langchaingo v0.1.14-pre.2.0.20250822161313-dd61fd90f4d9 // indirect
...
replace mcp-agent/agent_go => ../../agent_go
